...
class AppTranslations {
  static const Map<String, Map<AppLanguage, String>> _dict = {
    ...
    'greetingMorning': {
      ...
      AppLanguage.gujarati: 'શુભ સવાર,',
      AppLanguage.oriya: 'ଶୁଭ ସକାଳ,',
    },
    'greetingAfternoon': {
      AppLanguage.english: 'Good Afternoon,',
      AppLanguage.hindi: 'शुभ दोपहर,',
      AppLanguage.tamil: 'மதிய வணக்கம்,',
      AppLanguage.bengali: 'শুভ দুপুর,',
      AppLanguage.gujarati: 'શુભ બપોર,',
      AppLanguage.oriya: 'ଶୁଭ ଅପ୍ରାହ୍ନ,',
    },
    'greetingEvening': {
      AppLanguage.english: 'Good Evening,',
      AppLanguage.hindi: 'शुभ संध्या,',
      AppLanguage.tamil: 'மாலை வணக்கம்,',
      AppLanguage.bengali: 'শুভ সন্ধ্যা,',
      AppLanguage.gujarati: 'શુભ સાંજ,',
      AppLanguage.oriya: 'ଶୁଭ ସନ୍ଧ୍ୟା,',
    },
    'seekerLabel': {
      AppLanguage.english: 'Seeker',
      AppLanguage.hindi: 'साधक',
      AppLanguage.tamil: 'தேடுபவரே',
      AppLanguage.bengali: 'সাধক',
    ...
    'onboardingSkip': {
      ...
      AppLanguage.bengali: 'এড়িয়ে যান',
      AppLanguage.gujarati: 'છોડો',
      AppLanguage.oriya: 'ଛାଡ଼ନ୍ତୁ',
    },
    'onboardingNext': {
      ...
      AppLanguage.oriya: 'ଆଗକୁ',
    },
    'onboardingBegin': {
      AppLanguage.english: 'Begin Your Journey',
      AppLanguage.hindi: 'अपनी यात्रा शुरू करें',
      AppLanguage.tamil: 'உங்கள் பயணத்தைத் தொடங்குங்கள்',
      AppLanguage.bengali: 'আপনার যাত্রা শুরু করুন',
      AppLanguage.gujarati: 'તમારી યાત્રા શરૂ કરો',
      AppLanguage.oriya: 'ଆପଣଙ୍କ ଯାତ୍ରା ଆରମ୍ଭ କରନ୍ତୁ',
    },
    'onboardingTagline': {
      AppLanguage.english: 'Wisdom · Intelligence · Purpose',
      AppLanguage.hindi: 'ज्ञान · बुद्धि · उद्देश्य',
      AppLanguage.tamil: 'ஞானம் · புத்தி · நோக்கம்',
      AppLanguage.bengali: 'জ্ঞান · বুদ্ধিমত্তা · উদ্দেশ্য',
      AppLanguage.gujarati: 'જ્ઞાન · બુદ્ધિ · હેતુ',
      AppLanguage.oriya: 'ଜ୍ଞାନ · ବୁଦ୍ଧି · ଉଦ୍ଦେଶ୍ୟ',
    },
    // Slide 1
    'onboarding1Title': {
      AppLanguage.english: 'Welcome to DharmaAI',
      AppLanguage.hindi: 'DharmaAI में आपका स्वागत है',
      AppLanguage.tamil: 'DharmaAI-க்கு வரவேற்கிறோம்',
      AppLanguage.bengali: 'DharmaAI-তে আপনাকে স্বাগতম',
      AppLanguage.gujarati: 'DharmaAI માં આપનું સ્વાગત છે',
      AppLanguage.oriya: 'DharmaAI ରେ ଆପଣଙ୍କୁ ସ୍ୱାଗତ',
    },
    'onboarding1Subtitle': {
      AppLanguage.english: 'Your personal gateway to Vedic wisdom — ancient teachings, made alive for your daily life.',
      AppLanguage.hindi: 'वैदिक ज्ञान का आपका व्यक्तिगत द्वार — प्राचीन शिक्षाएं, आपके दैनिक जीवन में जीवंत।',
      AppLanguage.tamil: 'வேத ஞானத்திற்கான உங்கள் தனிப்பட்ட வாயில் — பண்டைய போதனைகள், உங்கள் அன்றாட வாழ்வில் உயிர்ப்படைகின்றன.',
      AppLanguage.bengali: 'বৈদিক জ্ঞানের আপনার ব্যক্তিগত প্রবেশদ্বার — প্রাচীন শিক্ষাগুলি আপনার দৈনন্দিন জীবনে জীবন্ত।',
      AppLanguage.gujarati: 'વૈદિક જ્ઞાન માટેનું તમારું વ્યક્તિગત પ્રવેશદ્વાર — પ્રાચીન શિક્ષણ, તમારા રોજિંદા જીવનમાં જીવંત.',
      AppLanguage.oriya: 'ବୈଦିକ ଜ୍ଞାନ ପାଇଁ ଆପଣଙ୍କ ବ୍ୟକ୍ତିଗତ ପ୍ରବେଶଦ୍ୱାର — ପ୍ରାଚୀନ ଶିକ୍ଷା, ଆପଣଙ୍କ ଦୈନନ୍ଦିନ ଜୀବନରେ ଜୀବନ୍ତ।',
    },
    // Slide 2
    'onboarding2Title': {
      AppLanguage.english: 'Explore Sacred Scriptures',
      AppLanguage.hindi: 'पवित्र शास्त्रों की खोज करें',
      AppLanguage.tamil: 'புனித வேதங்களை ஆராயுங்கள்',
      AppLanguage.bengali: 'পবিত্র শাস্ত্র অন্বেষণ করুন',
      AppLanguage.gujarati: 'પવિત્ર શાસ્ત્રો શોધો',
      AppLanguage.oriya: 'ପବିତ୍ର ଶାସ୍ତ୍ର ଅନ୍ୱେଷଣ କରନ୍ତୁ',
    },
    'onboarding2Subtitle': {
      AppLanguage.english: 'Dive into the Bhagavad Gita, the Vedas, and the Upanishads. Get verse-backed answers drawn from the full depth of Hindu scripture.',
      AppLanguage.hindi: 'भगवद गीता, वेदों और उपनिषदों में गहराई से उतरें। हिंदू शास्त्रों की पूर्ण गहराई से श्लोक-आधारित उत्तर प्राप्त करें।',
      AppLanguage.tamil: 'பகவத் கீதை, வேதங்கள் மற்றும் உபநிஷத்துகளை ஆழமாக ஆராயுங்கள். இந்து வேதங்களின் முழு ஆழத்திலிருந்து வசன-ஆதரவு பதில்களைப் பெறுங்கள்.',
      AppLanguage.bengali: 'ভগবদ গীতা, বেদ এবং উপনিষদে গভীরভাবে ডুব দিন। হিন্দু শাস্ত্রের সম্পূর্ণ গভীরতা থেকে শ্লোক-সমর্থিত উত্তর পান।',
      AppLanguage.gujarati: 'ભગવદ ગીતા, વેદ અને ઉપનિષદોમાં ઊંડા ઉતરો. હિન્દુ શાસ્ત્રોની સંપૂર્ણ ઊંડાઈ પરથી શ્લોક-સમર્થિત ઉત્તરો મેળવો.',
      AppLanguage.oriya: 'ଭଗବଦ ଗୀତା, ବେଦ ଏବଂ ଉପନିଷଦ ରେ ଗଭୀର ଭାବରେ ଡୁବନ୍ତୁ। ହିନ୍ଦୁ ଶାସ୍ତ୍ରର ସମ୍ପୂର୍ଣ ଗଭୀରତାରୁ ଶ୍ଲୋକ-ସମର୍ଥିତ ଉତ୍ତର ପାନ୍ତୁ।',
    },
    'onboarding2Hint': {
      AppLanguage.english: 'Find it under the Wisdom tab  ↓',
      AppLanguage.hindi: 'ज्ञान टैब में खोजें  ↓',
      AppLanguage.tamil: 'ஞானம் தாவலில் கண்டறியுங்கள்  ↓',
      AppLanguage.bengali: 'জ্ঞান ট্যাবের অধীনে খুঁজুন  ↓',
      AppLanguage.gujarati: 'જ્ઞાન ટૅબ હેઠળ શોધો  ↓',
      AppLanguage.oriya: 'ଜ୍ଞାନ ଟ୍ୟାବ ତଳେ ଖୋଜନ୍ତୁ  ↓',
    },
    // Slide 3
    'onboarding3Title': {
      AppLanguage.english: 'Your AI Guru',
      AppLanguage.hindi: 'आपका AI गुरु',
      AppLanguage.tamil: 'உங்கள் AI குரு',
      AppLanguage.bengali: 'আপনার AI গুরু',
      AppLanguage.gujarati: 'તમારા AI ગુરુ',
      AppLanguage.oriya: 'ଆପଣଙ୍କ AI ଗୁରୁ',
    },
    'onboarding3Subtitle': {
      AppLanguage.english: 'Have a continuous spiritual conversation. Your Guru remembers your journey and offers guidance tailored to you.',
      AppLanguage.hindi: 'निरंतर आध्यात्मिक वार्तालाप करें। आपके गुरु आपकी यात्रा को याद रखते हैं और आपके लिए विशेष मार्गदर्शन प्रदान करते हैं।',
      AppLanguage.tamil: 'தொடர்ச்சியான ஆன்மீக உரையாடல் கொள்ளுங்கள். உங்கள் குரு உங்கள் பயணத்தை நினைவில் வைத்து உங்களுக்கு ஏற்ற வழிகாட்டல் வழங்குகிறார்.',
      AppLanguage.bengali: 'একটি ক্রমাগত আধ্যাত্মিক কথোপকথন করুন। আপনার গুরু আপনার যাত্রা মনে রাখেন এবং আপনার জন্য বিশেষ নির্দেশনা দেন।',
      AppLanguage.gujarati: 'સતત આધ્યાત્મિક સંવાદ કરો. તમારા ગુરુ તમારી યાત્રા યાદ રાખે છે અને તમારા માટે વ્યક્તિગત માર્ગદર્શન આપે છે.',
      AppLanguage.oriya: 'ଏକ ନିରନ୍ତର ଆଧ୍ୟାତ୍ମିକ ସଂଳାପ କରନ୍ତୁ। ଆପଣଙ୍କ ଗୁରୁ ଆପଣଙ୍କ ଯାତ୍ରା ମନେ ରଖନ୍ତି ଏବଂ ଆପଣଙ୍କ ପାଇଁ ବ୍ୟକ୍ତିଗତ ମାର୍ଗଦର୍ଶନ ଦିଅନ୍ତି।',
    },
    'onboarding3Hint': {
      AppLanguage.english: 'Find it under the AI Guru tab  ↓',
      AppLanguage.hindi: 'AI गुरु टैब में खोजें  ↓',
      AppLanguage.tamil: 'AI குரு தாவலில் கண்டறியுங்கள்  ↓',
      AppLanguage.bengali: 'AI গুরু ট্যাবের অধীনে খুঁজুন  ↓',
      AppLanguage.gujarati: 'AI ગુરુ ટૅબ હેઠળ શોધો  ↓',
      AppLanguage.oriya: 'AI ଗୁରୁ ଟ୍ୟାବ ତଳେ ଖୋଜନ୍ତୁ  ↓',
    },
    // Slide 4
    'onboarding4Title': {
      AppLanguage.english: 'Build a Daily Sadhana',
      AppLanguage.hindi: 'दैनिक साधना बनाएं',
      AppLanguage.tamil: 'தினசரி சாதனா உருவாக்குங்கள்',
      AppLanguage.bengali: 'দৈনিক সাধনা গড়ুন',
      AppLanguage.gujarati: 'દૈનિક સાધના બનાવો',
      AppLanguage.oriya: 'ଦୈନିକ ସାଧନା ଗଢ଼ନ୍ତୁ',
    },
    'onboarding4Subtitle': {
      AppLanguage.english: 'Log meditation, chanting, and verse reading every day. Build streaks and watch your practice deepen over time.',
      AppLanguage.hindi: 'ध्यान, जप और श्लोक पाठ को प्रतिदिन लॉग करें। धाराएं बनाएं और अपने अभ्यास को गहरा होते देखें।',
      AppLanguage.tamil: 'தியானம், ஜபம் மற்றும் வசன வாசிப்பை தினமும் பதிவு செய்யுங்கள். தொடர்ச்சை உருவாக்கி உங்கள் பயிற்சி ஆழமடைவதைப் பாருங்கள்.',
      AppLanguage.bengali: 'প্রতিদিন ধ্যান, জপ এবং শ্লোক পাঠ লগ করুন। ধারা তৈরি করুন এবং আপনার অভ্যাস গভীর হতে দেখুন।',
      AppLanguage.gujarati: 'ધ્યાન, જપ અને શ્લોક વાંચન દરરોજ નોંધો. ધારા બનાવો અને તમારી પ્રેક્ટિસ ઊંડી થતી જુઓ.',
      AppLanguage.oriya: 'ପ୍ରତିଦିନ ଧ୍ୟାନ, ଜପ ଏବଂ ଶ୍ଲୋକ ପାଠ ଲଗ କରନ୍ତୁ। ଧାରା ଗଢ଼ନ୍ତୁ ଏବଂ ଆପଣଙ୍କ ଅଭ୍ୟାସ ଗଭୀର ହୋଇ ଯିବା ଦେଖନ୍ତୁ।',
    },
    'onboarding4Hint': {
      AppLanguage.english: 'Find it under the Sadhana tab  ↓',
      AppLanguage.hindi: 'साधना टैब में खोजें  ↓',
      AppLanguage.tamil: 'சாதனா தாவலில் கண்டறியுங்கள்  ↓',
      AppLanguage.bengali: 'সাধনা ট্যাবের অধীনে খুঁজুন  ↓',
      AppLanguage.gujarati: 'સાધના ટૅબ હેઠળ શોધો  ↓',
      AppLanguage.oriya: 'ସାଧନା ଟ୍ୟାବ ତଳେ ଖୋଜନ୍ତୁ  ↓',
    },
